...
export default function InstallationForm2({ onClose }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Détaillez votre projet d'installation (petit travaux) *</label>
        <textarea
          ...
          placeholder="Ex : ajout de prise, dépannage, modification simple, etc."
        />
      </div>
