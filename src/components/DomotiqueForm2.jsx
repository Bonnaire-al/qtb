...
export default function DomotiqueForm2({ onClose }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Détaillez votre projet domotique (petit travaux) *</label>
        <textarea
          ...
          placeholder="Ex : ajout d'un point lumineux, dépannage, modification simple, etc."
        />
      </div>
