...
export default function DomotiqueForm1({ onClose }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Détaillez votre projet domotique (rénovation globale / neuf) *</label>
        <textarea
          ...
          placeholder="Ex : gestion éclairage, volets, sécurité, etc."
        />
      </div>
