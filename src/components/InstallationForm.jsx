...
export default function InstallationForm({ onClose, onCancel, initialClientInfo = {} }) {
  ...
  return (
    <>
      <div className="max-h-[80vh] overflow-y-auto max-w-md mx-auto px-8">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-center mb-4">
            <h2 className="text-xl font-bold text-cyan-800">Installation électrique générale</h2>
          </div>
      ...
      {/* Modal Aperçu Devis avec ModalQuote - s'ouvre directement après "Générer le devis" */}
      {showDevisModal && (
        <ModalQuote
          onBackToStep1={handleBackToForm}
