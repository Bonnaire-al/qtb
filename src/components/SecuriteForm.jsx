...
export default function SecuriteForm1({ onClose }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Détaillez votre besoin en sécurité (rénovation globale / neuf) *</label>
        <textarea
          ...
          placeholder="Ex : alarme, caméra, contrôle d'accès, etc."
        />
      </div>
