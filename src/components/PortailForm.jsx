...
export default function PortailForm1({ onClose }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Détaillez votre projet de portail/volet (rénovation globale / neuf) *</label>
        <textarea
          ...
          placeholder="Ex : portail motorisé, volet roulant, dépannage, etc."
        />
      </div>
